...
class MssqlSchemaParser extends BaseSchemaParser
{
    ...
    protected function addForeignKeys(Table $table)
    {
        ...
        $stmt = $this->dbh->query("SELECT ccu1.TABLE_NAME, ccu1.COLUMN_NAME, ccu2.TABLE_NAME AS FK_TABLE_NAME, ccu2.COLUMN_NAME AS FK_COLUMN_NAME, ccu1.CONSTRAINT_NAME AS FK_NAME

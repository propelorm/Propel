...
DROP TABLE IF EXISTS IF EXISTS book CASCADE;
...
DROP TABLE IF EXISTS IF EXISTS author CASCADE;
...
DROP TABLE IF EXISTS IF EXISTS table1 CASCADE;
...
DROP TABLE IF EXISTS IF EXISTS table2 CASCADE;
...
DROP TABLE IF EXISTS IF EXISTS table3 CASCADE;
...
DROP TABLE IF EXISTS IF EXISTS x.book CASCADE;
...
DROP TABLE IF EXISTS IF EXISTS y.author CASCADE;
...
DROP TABLE IF EXISTS IF EXISTS x.book_summary CASCADE;
...
EOF;
	...
	public function testGetDropTableDDL()
	{
		$table = new Table('foo');
		$expected = "
DROP TABLE IF EXISTS IF EXISTS foo CASCADE;
";
...
DROP TABLE IF EXISTS IF EXISTS Woopah.foo CASCADE;
